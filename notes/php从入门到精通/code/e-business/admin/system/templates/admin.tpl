...
{section name=arr_id loop=$arr}
    <tr>
      ...
      <td width="100" align="center" valign="middle" class="right"><input id="modify" name="modify" type="button" class="btn" value="修改" onclick="javascript:showdiv('{$arr[arr_id].id}','{$arr[arr_id].name}');" style="border-color:#FFFFFF;"/><input id="delete" name="delete" type="button" value="删除" class="btn" onclick="javascript:deladmin({$arr[arr_id].id});" style="border-color:#FFFFFF;"></td>
    </tr>
{/section}
</form>
</table>
