              ...
              <table width="547" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#FBA720">
                ...
                <tr>
                  ...
                  <td width="389" bgcolor="#FFFFFF">
                      <textarea name="touser" cols="50" rows="10" id="readme"></textarea>
                  </td>
                  <td width="63" height="33" bgcolor="#FFFFFF" class="STYLE2">
                      <a href="#" onClick="javascript:document.getElementById('readme').value='';return false;">
                          <img src="images/_14.jpg" width="60" height="25" border="0" /></a>
                  </td>
                </tr>
                <tr>
                  <td rowspan="6" align="right" bgcolor="#FFFFFF">操作：</td>
                  <td height="30" colspan="2" align="left" bgcolor="#FFFFFF">
                      <input name="PHP3" type="checkbox" id="PHP3" value="PHP" />
                    C++编程词典全能版</td>
                </tr>
                <tr>
                  <td height="30" colspan="4" align="left" bgcolor="#FFFFFF">
                      <input name="PHP" type="checkbox" id="PHP" value="PHP" />
                    VC编程词典钻石版</td>
                </tr>
                <tr>
                  <td height="30" colspan="4" align="left" bgcolor="#FFFFFF">
                      <input name="PHP4" type="checkbox" id="PHP4" value="PHP" />
                    PHP编程词典体验版</td>
                </tr>
                <tr>
                  <td height="30" colspan="4" align="left" bgcolor="#FFFFFF">
                      <input name="PHP5" type="checkbox" id="PHP5" value="PHP" />
                    C#编程词典标准版</td>
                </tr>
                <tr>
                  <td height="30" colspan="4" align="left" bgcolor="#FFFFFF">
                      <input name="PHP6" type="checkbox" id="PHP6" value="PHP" />
                    VB编程词典全能版</td>
                </tr>
                <tr>
                  <td height="30" colspan="4" align="left" bgcolor="#FFFFFF">
                      <input name="PHP7" type="checkbox" id="PHP7" value="PHP" />
                    ASP编程词典体验版</td>
                </tr>
                <tr>
                  <td colspan="5" align="center" bgcolor="#FFFFFF">
                      ...
                      <img src="images/_11.jpg" width="60" height="25" onclick="uncheckAll(form1,status)" /> &nbsp;&nbsp;</td>
                </tr>
              </table>
            </form></td>
          <td>&nbsp;</td>
