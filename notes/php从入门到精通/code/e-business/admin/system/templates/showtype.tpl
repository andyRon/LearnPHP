...
{section name=big_id loop=$bigarray}
    ...
    <tr>
      <td height="25" align="center" valign="middle" class="left" style="text-indent: 50px;" ><font size="2" color="#996600">子类：</font><input id="moditype{$smallarray[small_id].id}" name="moditype{$smallarray[small_id].id}" type="text" class="shorttxt" value="{$smallarray[small_id].name}" style="border-color:#996633;" /></td>
